...
class TestTables(S3MinioMixin):
    ...
    def test_table_csv(self):
        self.bucket.upload_file(Filename=DATA_DIR / "test.csv", Key="TEST_KEY_CSV")
    ...
    def test_table_csv_gzip(self):
        self.bucket.upload_file(
            Filename=DATA_DIR / "test.csv.gz", Key="TEST_KEY_CSV_GZIP"
        )
    ...
    def test_table_csv_bzip2(self):
        self.bucket.upload_file(
            Filename=DATA_DIR / "test.csv.bz2", Key="TEST_KEY_CSV_BZIP2"
        )
    ...
    def test_table_json(self):
        self.bucket.upload_file(Filename=DATA_DIR / "test.json", Key="TEST_KEY_JSON")
    ...
    def test_table_json_gzip(self):
        self.bucket.upload_file(
            Filename=DATA_DIR / "test.json.gz", Key="TEST_KEY_JSON_GZIP"
        )
    ...
    def test_table_json_bzip2(self):
        self.bucket.upload_file(
            Filename=DATA_DIR / "test.json.bz2", Key="TEST_KEY_JSON_BZIP2"
        )
    ...
    def test_table_parquet(self):
        self.bucket.upload_file(
            Filename=DATA_DIR / "test.parquet", Key="TEST_KEY_PARQUET"
        )
    ...
    def test_table_sqlite(self):
        self.bucket.upload_file(
            Filename=DATA_DIR / "test.sqlite", Key="TEST_KEY_SQLITE"
        )
